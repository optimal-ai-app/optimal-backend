...
public class SupervisorFactory {
    ...
    /**
     * Creates a new BaseSupervisor instance with all dependencies properly injected.
     * This allows for stateful supervisors while maintaining Spring's dependency injection.
     */
    public BaseSupervisor createSupervisor() {
        ...
        supervisor.setContextAgent(contextAgent);
